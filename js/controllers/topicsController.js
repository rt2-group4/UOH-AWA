class TopicsController {
        ...
        this.topics = [
            {
                ...
                estimatedTime: 30,
                prerequisites: [],
                learningMaterialsPath: "/UOH-AWA/components/learning-materials/topic1.html",
                test: [
                    {
                        question: "What does WCAG stand for?",
                        options: ["Web Content Accessibility Guidelines", "Web Content Application Guide", "World Content Accessibility Group"],
                        answer: 0
                    },
                    {
                        question: "Why is accessibility important?",
                        options: ["Legal compliance", "Inclusive user experience", "Both"],
                        answer: 2
                    },
                ]
            },
            {
                ...
                estimatedTime: 45,
                prerequisites: [1],
                learningMaterialsPath: "/UOH-AWA/components/learning-materials/topic2.html",
                test: [
                    {
            ...
            },
            {
                ...
                estimatedTime: 40,
                prerequisites: [2],
                learningMaterialsPath: "/UOH-AWA/components/learning-materials/topic3.html",
                test: [
                    {
            ...
            },
            {
                ...
                estimatedTime: 35,
                prerequisites: [3],
                learningMaterialsPath: "/UOH-AWA/components/learning-materials/topic4.html",
                test: [
                    {
            ...
            },
            {
                ...
                estimatedTime: 35,
                prerequisites: [4],
                learningMaterialsPath: "/UOH-AWA/components/learning-materials/topic5.html",
                test: [
                    {
            ...
            },
            {
                ...
                estimatedTime: 45,
                prerequisites: [1, 2],
                learningMaterialsPath: "/UOH-AWA/components/learning-materials/topic6.html",
                test: [
                    {
            ...
            },
            {
                ...
                estimatedTime: 60,
                prerequisites: [1],
                learningMaterialsPath: "/UOH-AWA/components/learning-materials/topic7.html",
                test: [
                    {
                        question: "Question1",
    ...
    // Add new method to fetch learning materials
    async getLearningMaterials(topicId) {
        const topic = this.getTopicById(topicId);
        if (!topic || !topic.learningMaterialsPath) {
            return '<p>Learning materials not found.</p>';
        }

        try {
            const response = await fetch(topic.learningMaterialsPath);
            if (!response.ok) {
            ...
            return '<p>Error loading learning materials.</p>';
        }
    }
}
